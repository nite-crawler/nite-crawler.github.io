const Hero = () => {
  return <section 
    ...
    className="min-h-screen flex items-center justify-center relative overflow-hidden bg-cover bg-no-repeat bg-center sm:bg-[center_40%] md:bg-[center_35%] lg:bg-[center_30%]">
